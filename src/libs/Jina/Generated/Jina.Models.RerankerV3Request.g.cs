...
namespace Jina
{
    ...
    public sealed partial class RerankerV3Request
    {
        ...
        /// <summary>
        /// Maximum tokens per document (1-8192). Omit to use the model's default (2048 for jina-reranker-v3, 8192 for jina-reranker-v3.5).
        /// </summary>
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Jina.RerankerV3RequestModel Model { get; set; }
