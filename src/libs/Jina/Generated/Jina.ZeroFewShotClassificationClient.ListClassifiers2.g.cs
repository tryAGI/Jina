...
namespace Jina
{
    public partial class ZeroFewShotClassificationClient
    {
        ...
        private static readonly global::Jina.EndPointSecurityRequirement s_ListClassifiers2SecurityRequirement0 =
        ...
        private static readonly global::Jina.EndPointSecurityRequirement[] s_ListClassifiers2SecurityRequirements =
            new global::Jina.EndPointSecurityRequirement[]
            {                s_ListClassifiers2SecurityRequirement0,
            };
        partial void PrepareListClassifiers2Arguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareListClassifiers2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessListClassifiers2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListClassifiers2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>> ListClassifiers2Async(
            global::Jina.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListClassifiers2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Jina.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Jina.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>>> ListClassifiers2AsResponseAsync(
            global::Jina.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListClassifiers2Arguments(
                httpClient: HttpClient);


            var __authorizations = global::Jina.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ListClassifiers2SecurityRequirements,
                operationName: "ListClassifiers2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListClassifiers2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Jina.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Jina.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListClassifiers2",
                                methodName: "ListClassifiers2Async",
                                pathTemplate: "\"/v1/classifiers\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                cancellationToken: __effectiveCancellationToken).ConfigureAwait(false);
                    ...
                    {
                        var __retryDelay = global::Jina.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                            response: null,
                            attempt: __attempt);
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListClassifiers2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Jina.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListClassifiers2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Jina.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>>(
                                        statusCode: __response.StatusCode,
                                        headers: global::Jina.AutoSDKHttpResponse.CreateHeaders(__response),
                                        requestUri: __response.RequestMessage?.RequestUri,
                                        body: __value);
                                }
                                catch (global::System.Exception __ex)
                                {
                                    throw global::Jina.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Jina.ClassifierSummary>), JsonSerializerContext).ConfigureAwait(false) ??
