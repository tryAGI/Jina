...
namespace Jina
{
    public partial class GroundingClient
    {
        partial void PrepareGrounding2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string path);
        partial void PrepareGrounding2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string path);
        partial void ProcessGrounding2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGrounding2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> Grounding2Async(
            string path,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGrounding2Arguments(
                httpClient: HttpClient,
                path: ref path);

            var __pathBuilder = new PathBuilder(
                path: $"/v1/grounding/{path}",
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGrounding2ResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
